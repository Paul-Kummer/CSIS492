...
INSERT INTO `USER` VALUES (1,'Paul','28b3da6a4cad283dd294dd51d476084c'),(2,'Eric','d41d8cd98f00b204e9800998ecf8427e');
UNLOCK TABLES;
...
DELIMITER ;;
CREATE  FUNCTION `verifyPass`(uName varchar(45), uPass varchar(45)) RETURNS varchar(5) CHARSET latin1
BEGIN
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2020-11-25 21:52:36',NULL),('diagnostics.include_raw','OFF','2020-11-25 21:52:36',NULL),('ps_thread_trx_info.max_length','65535','2020-11-25 21:52:36',NULL),('statement_performance_analyzer.limit','100','2020-11-25 21:52:36',NULL),('statement_performance_analyzer.view',NULL,'2020-11-25 21:52:36',NULL),('statement_truncate_len','64','2020-11-25 21:52:36',NULL);
...
--
-- Current Database: `id15690826_climbtime`
--
...
-- Dump completed on 2020-12-16 10:30:42
