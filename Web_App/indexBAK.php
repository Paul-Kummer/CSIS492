...
<?php
	...
	$path = "http://puff.mnstate.edu/~cx3645kg/private/paulWall/index.php";
...
// END HERE
	...
	if ($_SESSION['dMode'])
	{
		$styleSheet = "http://puff.mnstate.edu/~cx3645kg/private/paulWall/dark.css";
	}

	else
	{
		$styleSheet = "http://puff.mnstate.edu/~cx3645kg/private/paulWall/light.css";
	}
	...
	<div class="row">
		<div class="navLinks">
			<form action=<?php echo $path?> method="POST">
				...
				<input type="submit" class="button" name="Submit" value="View Routes">
				<input type="submit" class="button" name="Submit" value="View Users">
				<input type="submit" class="button" name="Submit" value="View Sessions">
